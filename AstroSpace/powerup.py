...
class PowerUp:
    ...
    def apply(self, player):
        ...
        elif self.type == 'chrono':
            # Time freeze effect will be handled in main game loop
            player.time_freeze_active = True
            player.powerup_end_times['chrono'] = pygame.time.get_ticks() + self.info['duration']
