...
def load_assets():
    ...
    try:
        ...
        # Chrono Crystal powerup (light blue/white)
        chrono_powerup = pygame.Surface(powerup_size)
        chrono_powerup.fill((200, 200, 255))
        assets['powerup_chrono'] = chrono_powerup
    except Exception as e:
        ...
        chrono_powerup = powerup_placeholder.copy()
        chrono_powerup.fill((200, 200, 255))
        assets['powerup_chrono'] = chrono_powerup
